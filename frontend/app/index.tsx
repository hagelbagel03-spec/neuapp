...
const MainApp = ({ appConfig, setAppConfig }) => {
  ...
  const dynamicStyles = StyleSheet.create({
    ...
    // 🚀 HEADER BUTTONS - DUNKLES GRÜN THEME
    headerButton: {
    ...
    // 🚀 ULTRA-FUTURISTIC CYBER DASHBOARD STYLES - SO MODERN ES IST BEÄNGSTIGEND
    cyberDashboardContainer: {
      flex: 1,
      paddingHorizontal: 16,
    },
    ...
    // Ultra-Modern Incident Container
    cyberIncidentContainer: {
    ...
    // Incident Card - Ultra Futuristic
    cyberIncidentCard: {
    ...
    // Backup: Keep old styles for fallback
    statsContainer: {
      flexDirection: 'row',
      paddingHorizontal: 20,
      paddingTop: 24,
    ...
    // Danger/Delete Buttons - ALARM RED
    deleteButton: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center',
          ...
          <ScrollView style={{ flex: 1, padding: 20 }}>
            ...
            {user?.role === 'admin' && (
              <TouchableOpacity 
                ...
                onPress={() => {
                  setShowSettingsModal(false);
                  setShowAdminDashboardModal(true); // RICHTIG VERLINKT: Öffnet das Admin-Dashboard-Modal
                }}
              >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <View style={{
            ...
            <TouchableOpacity 
              ...
              onPress={() => {
                setShowSettingsModal(false);
                setShowShiftModal(true); // RICHTIG VERLINKT: Öffnet das Schichten-Modal
              }}
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{
